    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-12">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <ThemeSwitcher className="mr-3 text-muted-foreground transition-colors hover:text-foreground" />
        ...
        <button
          ...
          className="flex h-6 w-6 items-center justify-center text-foreground transition-colors hover:text-accent"
        >
